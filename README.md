...
**Design 2-5 visualizations for each discovered phenomena (4-10 total). You may work with a timespan of your choosing. Optionally, you may merge multiple datasets from different periods.**  #done
...
* Use your visualizations (does not have to be all of them) to design a dashboard for each phenomena. #done
* The dashboards should be accompanied with an analysis explaining why the phenomena may be occuring.  #NEEDED

**City officials would also like to see one of the following visualizations:**

* **Basic:** A static map that plots all bike stations with a visual indication of the most popular locations to start and end a journey with zip code data overlaid on top. #done
...
* A link to your Tableau Public workbook that includes: 
  ...
  * 2 Dashboards #Done
  * 1 City Official Map #Done
  * 1 Story #Needed
* A text or markdown file with your analysis on the phenomenons you uncovered from the data. #needed
